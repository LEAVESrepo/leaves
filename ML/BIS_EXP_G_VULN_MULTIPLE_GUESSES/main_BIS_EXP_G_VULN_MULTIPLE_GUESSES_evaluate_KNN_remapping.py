...
APPROACHES = ['KNN']
TRAINING_SET_SIZE = [90000, 270000, 450000]
# TRAINING_SET_SIZE = [int(sys.argv[1])]
TEST_SET_SIZE = [90000, 270000, 450000]
# TEST_SET_SIZE = [int(sys.argv[3])]
VALIDATION_SET_SIZE = [90000, 27000, 45000]
...
RESULT_FOLDER = "/home/comete/mromanel/MILES_EXP/BIS_EXP_G_VULN_MULTIPLE_GUESSES/RESULT_FOLDER_REMAPPING/KNN/"
utilities.createFolder(RESULT_FOLDER)

DATA_FOLDER = "/home/comete/mromanel/MILES_EXP/BIS_EXP_G_VULN_MULTIPLE_GUESSES/DATA_FOLDER/"

G_MATRIX_PATH = '/home/comete/mromanel/MILES_EXP/BIS_EXP_G_VULN_MULTIPLE_GUESSES/G_MAT_FOLDER/g_matrix_10_secrets_' + \
                str(NUMBER_OF_GUESSES) + '_guesses.pkl'
G_MATRIX_ROWS_PATH = '/home/comete/mromanel/MILES_EXP/BIS_EXP_G_VULN_MULTIPLE_GUESSES/G_MAT_FOLDER/g_matrix_10_secrets_' + \
                     str(NUMBER_OF_GUESSES) + \
                     '_guesses_rows.pkl'
G_MATRIX_COLS_PATH = '/home/comete/mromanel/MILES_EXP/BIS_EXP_G_VULN_MULTIPLE_GUESSES/G_MAT_FOLDER/g_matrix_10_secrets_' + \
...
def main_BIS_EXP_G_VULN_MULTIPLE_GUESSES_evaluate_KNN_remapping():
    ...
    if 'KNN' in APPROACHES:
        ...
        for size_list_iterator in range(len(TRAINING_SET_SIZE)):
            ...
            for train_iteration in range(TRAIN_ITERATIONS):
                ...
                # k_neighbors = int(round(np.log(len(O_train)), 0))
