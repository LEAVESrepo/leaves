"""
python main_EXP_G_VULN_MULTIPLE_GUESSES_train_single_classifier.py -lr 0.001 -hlc 1 -hnc [50] -e 1000 -bs 128 --id_gpu 0 --perc_gpu 0.3 -nu 0.02 -tr_size 10000 -val_size 1000 -ts_size 10000 -tr_iter 0 -mn model_name
"""
import sys
import pandas as pn
...
def main_EXP_G_VULN_MULTIPLE_GUESSES_train_single_ANN_remapping():
    read_command_line_options()

    thismodule = sys.modules[__name__]

    EXP_G_VULN_MULTIPLE_GUESSES_FOLDER = "/home/comete/mromanel/MILES_EXP/EXP_G_VULN_MULTIPLE_GUESSES/"
    utilities.createFolder(EXP_G_VULN_MULTIPLE_GUESSES_FOLDER)

    RESULT_FOLDER = EXP_G_VULN_MULTIPLE_GUESSES_FOLDER + "RESULT_FOLDER_REMAPPING/"
    ...
    DATA_FOLDER = EXP_G_VULN_MULTIPLE_GUESSES_FOLDER + "DATA_FOLDER_AFTER_OUR_PREPROCESSING_" + str(
        NUMBER_OF_GUESSES) + "_GUESSES/"
