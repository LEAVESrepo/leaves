...
TEST_ITERATIONS_END = 10
TRAIN_ITERATIONS = 1
SECRETS_CARD = 10
ENHANCED = False

RESULT_FOLDER = "/home/comete/mromanel/MILES_EXP/EMPIRICAL_ESTIMATES/RESULT_FOLDER_REMAPPING/"
utilities.createFolder(RESULT_FOLDER)

RESULT_FOLDER = "/home/comete/mromanel/MILES_EXP/EMPIRICAL_ESTIMATES/RESULT_FOLDER_REMAPPING/KNN/"
utilities.createFolder(RESULT_FOLDER)

DATA_FOLDER = "/home/comete/mromanel/MILES_EXP/EMPIRICAL_ESTIMATES/DATA_FOLDER_AFTER_OUR_PREPROCESSING/"

G_MATRIX_PATH = '/home/comete/mromanel/MILES_EXP/EMPIRICAL_ESTIMATES/G_MAT_FOLDER/g_matrix.pkl'
G_MATRIX_ROWS_PATH = '/home/comete/mromanel/MILES_EXP/EMPIRICAL_ESTIMATES/G_MAT_FOLDER/g_matrix_rows.pkl'
G_MATRIX_COLS_PATH = '/home/comete/mromanel/MILES_EXP/EMPIRICAL_ESTIMATES/G_MAT_FOLDER/g_matrix_cols.pkl'
...
def main_EMPIRICAL_ESTIMATES_evaluate_KNN_remapping():
        ...
        for size_list_iterator in range(len(TRAINING_SET_SIZE)):
            ...
            for train_iteration in range(TRAIN_ITERATIONS):
                training_data = pn.read_pickle(DATA_FOLDER + str(training_set_size) + "_training_and_" + str(
                    ...
                    test_set_size) + "_test_store_folder_train_iteration_" + str(train_iteration) + "/training_set.pkl")
                ...
                for test_iterator in range(TEST_ITERATIONS_BEG, TEST_ITERATIONS_END):
                    ...
                    test_set = pn.read_pickle(
                        path=DATA_FOLDER + str(training_set_size) + "_training_and_" + str(
                            ...
                            train_iteration) + "/" + str(test_set_size) + "_size_test_sets/test_set_" + str(
                            test_iterator)).values
