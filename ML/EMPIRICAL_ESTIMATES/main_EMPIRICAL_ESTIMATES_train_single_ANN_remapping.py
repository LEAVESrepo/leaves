"""
python main_EMPIRICAL_ESTIMATES_train_single_classifier.py -lr 0.001 -hlc 1 -hnc [50] -e 1000 -bs 128 --id_gpu 0 --perc_gpu 0.3 -nu 0.02 -tr_size 10000 -val_size 1000 -ts_size 10000 -tr_iter 0 -mn model_name
"""
import sys
import pandas as pn
...
def main_EMPIRICAL_ESTIMATES_train_single_ANN_remapping():
    read_command_line_options()

    thismodule = sys.modules[__name__]

    EMPIRICAL_ESTIMATES_FOLDER = "/home/comete/mromanel/MILES_EXP/EMPIRICAL_ESTIMATES/"
    utilities.createFolder(EMPIRICAL_ESTIMATES_FOLDER)

    RESULT_FOLDER = EMPIRICAL_ESTIMATES_FOLDER + "RESULT_FOLDER_REMAPPING/"
    ...
    DATA_FOLDER = EMPIRICAL_ESTIMATES_FOLDER + "DATA_FOLDER_AFTER_OUR_PREPROCESSING/"
