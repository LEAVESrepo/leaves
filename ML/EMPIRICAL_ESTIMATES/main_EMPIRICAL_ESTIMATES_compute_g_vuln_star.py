...
EXP_G_VULN_EMPIRICAL_ESTIMATES_FOLDER_PATH = "/home/comete/mromanel/MILES_EXP/EMPIRICAL_ESTIMATES/"
CHANNEL_PATH = EXP_G_VULN_EMPIRICAL_ESTIMATES_FOLDER_PATH + "channel_df_norm.pkl"
...
G_MATRIX_COLS_PATH = '/home/comete/mromanel/MILES_EXP/EMPIRICAL_ESTIMATES/G_MAT_FOLDER/' \
                     'g_matrix_cols.pkl'
FINAL_FILE_PATH = '/home/comete/mromanel/MILES_EXP/EMPIRICAL_ESTIMATES/R_star_with_g_matrix.txt'


def main_EMPIRICAL_ESTIMATES_compute_g_vuln_star():
    # %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
