...
DATA_FOLDER = "/home/comete/mromanel/MILES_EXP/EMPIRICAL_ESTIMATES/" \
              "DATA_FOLDER_AFTER_OUR_PREPROCESSING/"

G_MATRIX_PATH = '/home/comete/mromanel/MILES_EXP/EMPIRICAL_ESTIMATES/G_MAT_FOLDER/' \
                'g_matrix.pkl'
G_MATRIX_ROWS_PATH = '/home/comete/mromanel/MILES_EXP/EMPIRICAL_ESTIMATES/G_MAT_FOLDER/' \
                     'g_matrix_rows.pkl'
G_MATRIX_COLS_PATH = '/home/comete/mromanel/MILES_EXP/EMPIRICAL_ESTIMATES/G_MAT_FOLDER/' \
                     'g_matrix_cols.pkl'
...
def main_EMPIRICAL_ESTIMATES_evaluate_classifiers_remapping():
    ...
    if 'ANN' in APPROACHES:
        ...
        result_df = pn.DataFrame(data=result_matrix,
                                 columns=["ANN_Rf_values", "number_of_test_samples",
                                          ...
                                          "test_iteration"])
        result_df.to_pickle(
            path=RESULT_FOLDER + "/ANN_training_and_validation_result_df_train_size_" + str(
