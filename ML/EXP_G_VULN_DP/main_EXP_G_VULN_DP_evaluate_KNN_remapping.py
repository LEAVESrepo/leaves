...
RESULT_FOLDER = "/home/comete/mromanel/MILES_EXP/EXP_G_VULN_DP_FOLDER/RESULT_FOLDER_REMAPPING/KNN/"
utilities.createFolder(RESULT_FOLDER)

DATA_FOLDER = "/home/comete/mromanel/MILES_EXP/EXP_G_VULN_DP_FOLDER/DATA_FOLDER_AFTER_OUR_PREPROCESSING/"
DATA_FOLDER_TEST = "/home/comete/mromanel/MILES_EXP/EXP_G_VULN_DP_FOLDER/DATA_FOLDER/" + str(
...
def main_EXP_G_VULN_DP_evaluate_KNN_remapping():
    ...
    if 'KNN' in APPROACHES:
        ...
        for size_list_iterator in range(len(TRAINING_SET_SIZE)):
            ...
            for train_iteration in range(TRAIN_ITERATIONS):
                ...
                O_train = training_data.values[:, 0:training_data.values.shape[1] - 2]
                S_train = training_data.values[:, -2]
                Z_train = training_data.values[:, -1]
