...
RESULT_FOLDER = "/home/comete/mromanel/MILES_EXP/EXP_GEO_LOCATION_QIF_LIB_SETTING/RESULT_FOLDER_REMAPPING/"

DATA_FOLDER = "/home/comete/mromanel/MILES_EXP/EXP_GEO_LOCATION_QIF_LIB_SETTING/DATA_FOLDER_AFTER_OUR_PREPROCESSING/"
DATA_FOLDER_TEST = "/home/comete/mromanel/MILES_EXP/EXP_GEO_LOCATION_QIF_LIB_SETTING/DATA_FOLDER/"

G_MATRIX_PATH = '/home/comete/mromanel/MILES_EXP/EXP_GEO_LOCATION_QIF_LIB_SETTING/G_OBJ/g_mat.pkl'
G_MATRIX_ROWS_PATH = '/home/comete/mromanel/MILES_EXP/EXP_GEO_LOCATION_QIF_LIB_SETTING/G_OBJ/g_mat_rows.pkl'
G_MATRIX_COLS_PATH = '/home/comete/mromanel/MILES_EXP/EXP_GEO_LOCATION_QIF_LIB_SETTING/G_OBJ/g_mat_cols.pkl'
    ...
    if 'ANN' in APPROACHES:
        ...
        for size_list_iterator in range(len(TRAINING_SET_SIZE)):
            ...
            for train_iteration in range(TRAIN_ITERATIONS):
                ...
                print "\n\n\n\n\n\n\n\n#################################  test_size: " + str(
                    test_set_size) + " ################################"
                ANN_file_Rf_ANN_g_leak = open(filepath + "/ANN_" + str(training_set_size) + "_training_and_" + str(
                ...
                for test_iterator in range(TEST_ITERATIONS_BEG, TEST_ITERATIONS_END):
                    ...
                    Rf_ANN_g_leak = g_vuln_computation.compute_g_vuln_with_remapping(final_mat=final_matrix,
