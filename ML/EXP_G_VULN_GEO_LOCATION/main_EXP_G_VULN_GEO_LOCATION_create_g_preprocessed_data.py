...
G_MATRIX_K_PATH = EXP_G_VULN_GEO_LOCATION_FOLDER + 'G_OBJ/K.pkl'

FINAL_DATA_FOLDER = EXP_G_VULN_GEO_LOCATION_FOLDER + "DATA_FOLDER_AFTER_OUR_PREPROCESSING/"

if not os.path.exists(FINAL_DATA_FOLDER):
    os.makedirs(FINAL_DATA_FOLDER)


def main_EXP_G_VULN_GEO_LOCATION_create_g_preprocessed_data():
