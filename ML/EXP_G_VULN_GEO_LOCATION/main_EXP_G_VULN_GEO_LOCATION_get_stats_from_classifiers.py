...
NUM_CLASSES = 400
NU = 0.02
TRAINING_SET_SIZE = [17665, 35162, 52827]
TEST_SET_SIZE = [17665, 35162, 52827]
VALIDATION_SET_SIZE = [1763, 3522, 5276]
TEST_ITERATIONS = 100
TRAIN_ITERATIONS = 10
MODEL_NAME = ""
...
def eval_on_dataset(data_set, model, min_max_scaler):
    ...
    loss, acc = model.evaluate(x=X_data_preprocessed, y=y_data, batch_size=1000)
